...
<body>
    <section class="congratulations">
        ...
        <p>You succefully launched an application <em>PHP</em> application is now running on your own dedicated environment in the AWS&nbsp;Cloud</p>
        <p>You are running PHP version <?= phpversion() ?></p>
        <p>This is new version </p>
    </section>
